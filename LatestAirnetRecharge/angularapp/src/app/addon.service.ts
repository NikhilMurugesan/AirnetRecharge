...
export class AddonService {
  ...
  private baseUrl1 = "http://localhost:8080/admin/viewAddon";
  private baseUrl2 = "http://localhost:8080/admin/deleteAddon";
  private baseUrl3 = "http://localhost:8080/admin/updateAddon";
