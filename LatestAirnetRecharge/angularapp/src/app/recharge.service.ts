...
export class RechargeService {
  ...
  private baseURL = "http://localhost:8080/admin/addRecharge";
  private baseUrl1 = "http://localhost:8080/admin/viewRecharge";
  private baseUrl2 = "http://localhost:8080/admin/deleteRecharge";
  private baseUrl3 = "http://localhost:8080/admin/editEvent";
