...
export class PlanServService {
  ...
  private baseURL = "http://localhost:8080/admin/addPlan";
  private baseUrl1 = "http://localhost:8080/admin/viewPlan";
  private baseUrl2 = "http://localhost:8080/admin/deletePlan";
  private baseUrl3 = "http://localhost:8080/admin/updatePlan";
